 ...
 */
$de->data['header'] = 'Derp';
$de->data['slogan'] = 'A PHP-based MVC-inspired CMF';
$de->data['logo']         = theme_url('logo_80x80.png');
$de->data['logo_width']   = 80;
$de->data['logo_height']  = 80;
$de->data['footer'] = <<<EOD
<p>&copy; Derp by Hampus Kvarnhammar</p>
