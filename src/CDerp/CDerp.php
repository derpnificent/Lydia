<?php
/**
 * Main class for Derp, holds everything.
 *
 * @package Derp
 */
class CDerp implements ISingleton {
  ...
  */
  ...
  protected function __construct() {
    ...
    // include the site specific config.php and create a ref to $de to be used by config.php
    $de = &$this;
   ...
   * @return CDerp The instance of this class.
   */
  public static function Instance() {
    if(self::$instance == null) {
      self::$instance = new CDerp();
    }
  ...
  public function ThemeEngineRender() {
    ...
    // Add stylesheet name to the $de->data array
    $this->data['stylesheet'] = $this->config['theme']['stylesheet'];
    
    // Make the theme urls available as part of $de
