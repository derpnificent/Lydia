<?php
/**
 * A model for managing Derp modules.
 * 
 * @package Derp
 */
class CMModules extends CObject {
   ...
   * Properties
   */
  private $DerpCoreModules = array('CDerp', 'CDatabase', 'CRequest', 'CViewContainer', 'CSession', 'CObject');
  private $DerpCMFModules = array('CForm', 'CCPage', 'CCBlog', 'CMUser', 'CCUser', 'CMContent', 'CCContent', 'CFormUserLogin', 'CFormUserProfile', 'CFormUserCreate', 'CFormContent', 'CHTMLPurifier');
  ...
  private function GetDetailsOfModule($module) {
    ...
    if(class_exists($module)) {
      ...
      $details['isDerpCore']   = in_array($rc->name, $this->DerpCoreModules);
      $details['isDerpCMF']    = in_array($rc->name, $this->DerpCMFModules);
